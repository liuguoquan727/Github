...
public class JavaPresenter extends JavaContract.IRepositoryPresenter {
  /**
   ...
   */
  public JavaPresenter(LifecycleProvider<ActivityEvent> provider, PausedHandler handler) {
  ...
  @Override public void searchRepository(SearchRepositoryCondition condition) {
    Api.getSearchApi()
        ...
        .compose(mProvider.<RepositoryModel>bindUntilEvent(ActivityEvent.DESTROY))
